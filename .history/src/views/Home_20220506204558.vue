<template>
    ...
    <el-container>
     ...
     <el-footer class="palyer">
       <hr style="FILTER:alpha(opacity=100,finishopacity=0,style=1); margin-bottom:12px; " width="97%" color=#fffff SIZE=3>
      <hr style="FILTER:alpha(opacity=100,finishopacity=0,style=1); margin-top:-15px;width:50%;margin-right:50%" width="97%" color=#00cc99 SIZE=3>
       <el-image :src="require(`/src/assets/home/previous.svg`)"
       style="margin-left:17px; margin-bottom:7px"
       ></el-image>
       <el-image :src="require(`@/assets/img/gods/${backUrl}`)"
       style="margin: 0 12px"
       ></el-image>
...
export default {
  ...
  data() {
    return{
      url: String,
      mUrl: String,
      playUrl: "/src/assets/home/play.svg",
      is_stop: Boolean
    }
  },
  methods: {
    change() {
      ...
      if(this.is_stop == true) {
        this.playUrl = "/src/assets/home/pause.svg";
        this.is_stop = false;
      }
      else {
        this.playUrl = "/src/assets/home/play.svg";
        this.is_stop = true;
      }
