<template>
    ...
    <el-container>
     ...
     <el-footer class="player">
      ...
      <el-slider v-model="progress" active-color="#00cc99" @change="changeLong"
...
————————————————
版权声明：本文为CSDN博主「前端-珊珊」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qq_34672907/article/details/124389392
</style>
