<template>
    ...
    <el-container>
     ...
     <el-footer class="palyer">
       <hr style="FILTER:alpha(opacity=100,finishopacity=0,style=1); margin-bottom:12px; width:50%;margin-right:50%" width="97%" color=#fffff SIZE=3>
      <hr style="FILTER:alpha(opacity=100,finishopacity=0,style=1); margin-top:-15px;" width="97%" color=#00cc99 SIZE=3>
