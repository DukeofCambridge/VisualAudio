<template>
    <div  class="player">
      ...
      >
       ...
       :style="{'opacity':song.is_stop?'1':'0','margin':'0px 12px'}"
       class = "play"
       ></el-image>
       <el-image :src="require(`/src/assets/home/pause.svg`)"
        :style="{'opacity':song.is_stop?'0':'1','margin':'0px 0px 0px -56px','position':'absolute'}"
       @click="change()"
       v-on:click.stop
       class = "play"
       ></el-image>
    ...
    <audio  :src="song.url"
       ...
       @timeupdate="getCurr"
       @canplay="showLong"
        @pause="song.is_stop==true"
        @play="song.is_stop==false"
      >
    </audio>
</template>
...
export default({
  ...
  methods: {
    ...
    /* setup() {
        this.song.url = props.song.url;
        this.song.picUrl = props.song.picUrl;
    }, */
    mounted: async function (){
/*         console.log("ww:"+this.song.url)
        this.song.url = props.song.url;
        this.song.picUrl = props.song.picUrl; */
