<template>
  <div class="player">
    ...
    >
      <template #reference>
        <el-image
          :src="control.volume == 0 || control.muted == true ? '/src/assets/home/silence.svg' : '/src/assets/home/volume.svg'"
          class="volume"
...
export default {
  ...
  data() {
    return {
      ...
      volumePath: '../../static/image/mipmap-xhdpi/on.png',
      silencePath: '../../static/image/mipmap-xhdpi/off.png'
    };
  },
  methods: {
    /**
