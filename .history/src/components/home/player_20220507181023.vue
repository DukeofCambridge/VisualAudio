...
:deep().process||#volume .el-slider__button {
  width: 8px;
  height: 8px;
  background: #00cc99;
...
:deep().process .el-slider__runway:hover .el-slider__button {
  visibility: visible;
}

:deep().process .el-slider__bar {
  background-color: #00cc99;
  height: 5px;
}
:deep().process .el-slider__runway {
