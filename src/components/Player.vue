<template>
  ...
  <el-row :gutter="0">
    ...
    <el-col :span="1" :offset="15">
      <el-image :src="song.picUrl" style="border-radius: 10%">
        <template #error>
    ...
    <el-col :span="2">
      <div style="word-wrap: break-word">
        <p style="text-align: left; margin: -4px 0 0 10px; font-size: 18px">
          {{ song.name }}
        </p>
        <p
          style="
...
export default {
  ...
  methods: {
    ...
    showLong() {
      ...
      /* this.$parent.wave = false;
      this.$nextTick(() => {
        // 重新渲染波浪组件
        console.log("重新加载");
        console.log(this.song.name);
        this.$parent.wave = true;
      }); */
    },
    /**
     * <el-slider>
    ...
    changeVolume() {
      ...
      // 改变wave audio的音量
      this.$parent.$refs.wave.setVolume(volume)
    },
    /**
     * <el-image>
     * 点击音量按键，静音或取消
    ...
    closeVolume() {
      ...
      if(this.control.muted == true) {
        // 改变wave audio的音量
        this.$parent.$refs.wave.setVolume(0)
      } else {
        this.$parent.$refs.wave.setVolume(this.control.volume/100)
      }
